...
message("Get the time of our solved matrix object")
print(system.time(cachematrix1 <- cacheSolve(testcachematrix)))

message("Get the time of our solved matrix object (cached)")
...
message("Get the time of our solved cached matrix object")
